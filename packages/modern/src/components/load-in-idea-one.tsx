      ...
      */}
      <Container className="">
        <nav>
          ...
          >
            <motion.li
              className="pointer ease-in-out transition-transform"
              whileHover={circleOne.whileHover}
              variants={circleOne}
              style={freezeOne}
              onHoverStart={() => setHoveredOne(true)}
              onHoverEnd={() => setHoveredOne(false)}
            >
              <div className="1 rounded-full bg-gray-500 h-24 w-24" />
            </motion.li>
            <motion.li
              className="pointer ease-in-out transition-transform"
              whileHover={circleOne.hover}
              variants={circleTwo}
              style={freezeTwo}
              onHoverStart={() => setHoveredTwo(true)}
              onHoverEnd={() => setHoveredTwo(false)}
            >
              <div className="2 rounded-full bg-blue-500 h-24 w-24" />
            </motion.li>
            <motion.li
              className="pointer ease-in-out transition-transform"
              whileHover={circleOne.hover}
              variants={circleThree}
              style={freezeThree}
              onHoverStart={() => setHoveredThree(true)}
              onHoverEnd={() => setHoveredThree(false)}
            >
              <div className="3 rounded-full bg-green-500 h-24 w-24" />
            </motion.li>
            <motion.li
              className="pointer ease-in-out transition-transform"
              whileHover={circleOne.hover}
              variants={circleFour}
              style={freezeFour}
              onHoverStart={() => setHoveredFour(true)}
              onHoverEnd={() => setHoveredFour(false)}
            >
              <div className="4 rounded-full bg-red-500 h-24 w-24" />
            </motion.li>
            <motion.li className="ease-in-out transition-transform z-10">
            ...
            <motion.li
              ...
              variants={circleFive}
              style={freezeFive}
              onHoverStart={() => setHoveredFive(true)}
              onHoverEnd={() => setHoveredFive(false)}
            >
              <div className="5 rounded-full bg-yellow-500 h-24 w-24" />
            </motion.li>
            <motion.li
              className="pointer ease-in-out transition-transform"
              whileHover={circleOne.hover}
              variants={circleSix}
              style={freezeSix}
              onHoverStart={() => setHoveredSix(true)}
              onHoverEnd={() => setHoveredSix(false)}
            >
              <div className="6 rounded-full bg-purple-500 h-24 w-24" />
            </motion.li>
            <motion.li
              className="pointer ease-in-out transition-transform"
              whileHover={circleOne.hover}
              variants={circleSeven}
              style={freezeSeven}
              onHoverStart={() => setHoveredSeven(true)}
              onHoverEnd={() => setHoveredSeven(false)}
            >
              <div className="7 rounded-full bg-orange-500 h-24 w-24" />
            </motion.li>
            <motion.li
              className="pointer ease-in-out transition-transform"
              whileHover={circleOne.hover}
              variants={circleEight}
              style={freezeEight}
              onHoverStart={() => setHoveredEight(true)}
              onHoverEnd={() => setHoveredEight(false)}
            >
              <div className="8 rounded-full bg-teal-500 h-24 w-24" />
            </motion.li>
          </motion.ul>
        </nav>
      </Container>
