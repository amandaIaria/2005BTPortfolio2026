...
function HomepageNavigation({ json }: HomepageNavigationProps) {
  ...
  return (
    <section
      data-component="homepage-navigation"
      className="relative -m-10 -mt-20"
    >
      <div className="w-screen h-screen p-0 m-1 grid place-items-center">
        <nav aria-label={t('homepageNavigation.navLabel')}>
          <motion.ul
            ref={ulRef}
                ...
                >
                  <div className="rounded-full bg-transparent h-100 w-100">
                    <div className="h-full w-full grid place-items-center ">
                      <img
                        src="/Object.png"
                        alt={t('homepageNavigation.selfPortraitAlt')}
